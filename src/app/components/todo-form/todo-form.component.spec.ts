...
describe('AppComponent', () => {
  ...
  it('should correctly pass activeCount and currentFilter to the footer', () => {
    // ✅ Modify todos instead of setting activeCount directly
    component.todos = [
    ...
    expect(footer.activeCount).toBe(2); // ✅ Two active todos
    expect(footer.currentFilter).toBe('active');
  });

  it('should call addTodo when TodoForm emits addTodo event', () => {
    spyOn(component, 'addTodo');

    // ✅ Use the correct event name: "add"
